...
const projects = [
  { 
    title: "Custom DBMS",
    description: "A custom database engine with page oriented content addressable storage, deduplication, and B+ Tree indexing, getting rid of redundant full page writes. One of my favourite projects, since it really taught me a lot about concurrency and threading!", 
    technologies: ["C++", "B+ Tree", "Writer Thread", "Write Ahead Logging", "Serialization", "Deduplication", "Page-Oriented Storage"],
    link: "https://github.com/AndrewSasmito/CustomDatabase"
  },
  { 
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 6 }}>
      <Box sx={{ textAlign: "center", mb: 6 }}>
        ...
        >
          A collection of my work! This is where I showcase my passion for software development, 
